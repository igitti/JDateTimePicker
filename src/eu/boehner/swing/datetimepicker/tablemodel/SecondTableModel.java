...
/**
 * A {@link DateTimePickerTableModel} for selecting the second.<br/>
 * All seconds of a minute are selectable.
 * So there are 60 elements which are arranged in 10 colums and 6 rows.
 * 
 * @author Daniel https://github.com/igitti/
 * 
 */
public class SecondTableModel extends DateTimePickerTableModel {

	private static final int ROWS = 6;
	private static final int COLS = 10;
	private static final SimpleDateFormat HEADER_SIMPLE_DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:");
	...
	protected void render() {
		...
		for (int i = 0; i < ROWS; i++) {
			for (int j = 0; j < COLS; j ++) {
				values[i][j] = String.valueOf(calendar.get(Calendar.SECOND));
